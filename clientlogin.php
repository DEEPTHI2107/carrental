...
?>
    ...
    <head>
        <title>Admin Login |AD Car Rental </title>
...
<div>
            <center>    <h1>Welcome to AD Car Rental </span>
                ...
                <br>
                <h3><strong>Kindly LOGIN to continue.</strong></h3>
<br>
<br>
<h2>LOGIN</h2>
            </div>
...
<br>
            ...
            <div style=" padding-left:600px; width:1000px;">
...
<br>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5 style="color:white">© 2021 AD Car Rental</h5>
                </div>
            </div>
        </div>
</div>
