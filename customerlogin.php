...
?>
    ...
    <head>
        <title> Customer Login |AD Car Rental </title>
    </head>
    ...
    <body style="background-image: url('taxi.jpg');position: relative;
    opacity: 0.9;
...
<a href="available.php">AVAILABLE CARS</a>
        ...
        <div >
            <div>
              <center>  <h1>Welcome to AD Car Rental </span>
                </h1>
                <br>
                <p><strong>Kindly LOGIN to continue.</strong></p></center>
            </div>
        </div>
<br><center>
LOGIN</center>
...
<br>
        <div class="container" style="margin-top: -2%; margin-bottom: 2%;">
            <div class="col-md-5 col-md-offset-4">
                ...
                <div class="panel panel-primary" style="background-color:#A2DBFA;">
