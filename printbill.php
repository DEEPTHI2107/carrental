...
?>
    ...
    <div >
        <div class="jumbotron">
            <h1 class="text-center" style="color: #39A2DB;"><span class="glyphicon glyphicon-ok-circle"></span> Car Returned</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center"> Thank you for visiting AD Car Rental! </h2>
    ...
    <div class="container">
        ...
        <div class="box" style="background-color:#A2DBFA; ">
        ...
        <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6>Warning! If you want a hardcopy of this page, please print it now.</h6>
        </div>
    </div>
