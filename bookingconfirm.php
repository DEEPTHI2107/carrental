...
<a href="available.php">AVAILABLE CARS</a>
        ...
        <!-- /.container -->
            ...
            <h1 class="text-center" style="color: #39A2DB;"><span class="glyphicon glyphicon-ok-circle"></span> Booking Confirmed.</h1>
        </div>
    ...
    <div class="container">
        ...
        <div class="box" style="background-color:#A2DBFA;" >
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                ...
                <br>
                <h3 style="color: #39A2DB;">Invoice</h3>
                <br>
            </div>
        ...
        <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6>Warning! <strong>If you want a hardcopy of this page, please print it now.</h6>
        </div>
    </div>
</body>
<?php } else { ?>
