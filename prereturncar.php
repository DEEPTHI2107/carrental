...
<body  style="background-image: url('');position: relative;
    opacity: 0.9;
    background-attachment: fixed;
    background-position: center;
    background-repeat: no-repeat;
    
height:900px;id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
<!-- Navigation -->
...
<div >
      <div ><center>
        ...
        <p> <strong>Hope you enjoyed our service :)</strong></p>
      </div></center>
    </div>
<br>
<br>
...
<?php        } ?>
        ...
        <?php } else {
            ...
            <div >
      <div class="jumbotron">
      <center>  <h1>No cars to return.</h1>
       </center>
      </div>
    </div>
